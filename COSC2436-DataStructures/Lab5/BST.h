...
/////////////////////////////////////////////////////
	...
	int getHeight() const; //Gets the height of the tree
	
	int getNumberOfNodes() const; //Gets the number of nodes on the tree
	
	int getNumberOfLeaves() const; //Gets the number of leaves on the tree
	
	void preOrder(ostream & out) const; //Pre order traversal for Tree
	
    void postOrder(ostream & out) const; //Post order traversal for the tree
...
/////////////////////////////////////////////////////
    ...
    void preOrderAux(ostream & out, BinaryNode<ItemType>* subtreePtr) const;
    
    void postOrderAux(ostream & out, BinaryNode<ItemType>* subtreePtr) const;
    
    int getHeightHelper(BinaryNode<ItemType>* myPtr) const; //Gets the height of the tree
    
    int getNodeHelper(BinaryNode<ItemType>* myPtr) const; 
    
    int getLeavesHelper(BinaryNode<ItemType>* myPtr) const;
